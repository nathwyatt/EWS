  ...
  <div class="tab-pane fade show active" id="settings" role="tabpanel" aria-labelledby="settings-tab">
    <div class="tab-pane-content mt-5">
      <form action="{{ route('profile.update',$user->id) }}" method="POST">
        ...
        <div class="form-group row mb-6">
          <label for="name" class="col-sm-4 col-lg-2 col-form-label">full names </label>
          <div class="col-sm-8 col-lg-10">
            <div class="custom-file mb-1">
              <input type="text" class="form-control" id="name" value="User names">
            </div>
          </div>
        </div>
        ...
        <div class="form-group row mb-6">
          ...
          <div class="col-sm-8 col-lg-10">
            <div class="custom-file mb-1">
              <input type="text" class="form-control" id="confirm-password" value="conPassword">
            </div>
          </div>
        </div>
