...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light fixed-top">
    ...
    <li class="dropdown user-menu">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
        <!-- User image -->
        <li class="dropdown-header"style=" background-color: #1d9d6e;color: #fff">
  ...
  <aside class="main-sidebar elevation-4 custom-sidebar">
    ...
    <a href="" class="brand-link">
        ...
        <span class="brand-text font-weight-light"style="color: #fff">MUVUMBA</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="form-inline">
            <div class="input-group" data-widget="sidebar-search">
                <input class="form-control form-control-sidebar" type="search" placeholder="Search" aria-label="Search"style="color: #000">
                <div class="input-group-append">
                    <button class="btn btn-sidebar">
                        <i class="fas fa-search fa-fw"></i>
                    </button>
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        ...
                        <p style="color: #000">@lang('public.chart') <i class="right fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p style="color: #000">Bar charts</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p style="color: #000">Flot</p>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        ...
                        <p style="color: #000">@lang('public.profile') <i class="right fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
